...
try {
    ...
    $stmt = $db->prepare("INSERT INTO siswa (id, user_id, sekolah_id, nis, nama, kelas, jenis_kelamin, tanggal_lahir, nama_wali, no_telp_wali, qr_code_token) 
                          VALUES (UUID(), :user_id, :sekolah_id, :nis, :nama, :kelas, :jenis_kelamin, :tanggal_lahir, :nama_wali, :no_telp_wali, :qr_code)");
